...
import { BrainCircuit, Mail, AlertCircle, ArrowRight, CheckCircle, Sparkles } from 'lucide-react';
        ...
        <Card className="w-full border-0 shadow-2xl shadow-slate-200/50 dark:shadow-black/50 bg-white/80 dark:bg-[#111318]/80 backdrop-blur-xl rounded-2xl overflow-hidden">
          ...
          <CardHeader className="text-center pb-4 pt-8">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 dark:bg-blue-500/10 border border-blue-500/20 mx-auto mb-4">
              ...
              <span className="text-xs font-medium text-blue-600 dark:text-blue-400">Account Recovery</span>
            </div>
            ...
            {success ? (
              <div className="text-center space-y-4 py-6">
                ...
                <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">
                  If an account exists for <strong className="text-blue-600 dark:text-blue-400">{email}</strong>, 
                  you will receive password reset instructions shortly.
                </p>
                <div className="pt-4 space-y-3">
                  <Link href="/login" className="block w-full">
                    <Button className="w-full h-11 bg-gradient-to-r from-slate-800 to-slate-900 text-white dark:from-white dark:to-slate-100 dark:text-slate-900 rounded-xl font-semibold hover:shadow-lg transition-all">
                      Return to Sign In
                    </Button>
                  </Link>
                </div>
